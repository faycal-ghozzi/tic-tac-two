...
export default function Footer() {
  return (
    <footer className="w-full mt-12 py-6 bg-gray-100 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 text-sm text-gray-600 dark:text-gray-400">
